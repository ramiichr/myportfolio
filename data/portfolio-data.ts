...
export const portfolioData: LocalizedData = {
  profile: {
    en: {
      ...
      description:
        "A passionate frontend developer with a Masters in Media Informatics. With a strong foundation in modern technologies and experience in developing user-centric solutions, I specialize in building impactful applications, solving complex problems, meeting deadlines and delivering scalable projects.",
    ...
    de: {
      ...
      description:
        "Ein leidenschaftlicher Frontend Entwickler mit einem Master in Medieninformatik. Mit einem starken Fundament in modernen Technologien und Erfahrung in der Entwicklung von nutzerzentrierten Lösungen, bin ich darauf spezialisiert, wirkungsvolle Anwendungen zu erstellen, komplexe Probleme zu lösen, Fristen einzuhalten und skalierbare Projekte zu liefern.",
      email: "ramii.cheikhrouhou@gmail.com",
      phone: "+49 176 20174689",
  ...
  skills: [
    ...
    { name: "SASS/SCSS", icon: "sass", category: "frontend", level: 4 },
    { name: "Bootstrap", icon: "bootstrap5", category: "frontend", level: 4 },
    {
      name: "Tailwind CSS",
      icon: "tailwindcss",
      category: "frontend",
    ...
    { name: "React", icon: "reactjs", category: "frontend", level: 5 },
    { name: "Next.js", icon: "nextjs2", category: "frontend", level: 4 },
    { name: "Vue.js", icon: "vuejs", category: "frontend", level: 3 },
    { name: "Node.js", icon: "nodejs", category: "backend", level: 4 },
    { name: "Express", icon: "", category: "backend", level: 4 },
    { name: "PHP 8", icon: "php", category: "backend", level: 4 },
    { name: "Laravel", icon: "laravel", category: "backend", level: 4 },
    { name: "Ruby on Rails", icon: "ruby", category: "backend", level: 3 },
    { name: "Redis", icon: "redis", category: "backend", level: 3 },
    { name: "MySQL", icon: "mysql", category: "backend", level: 4 },
    { name: "MongoDB", icon: "mongodb", category: "backend", level: 4 },
    { name: "Docker", icon: "docker", category: "backend", level: 4 },
    ...
    { name: "Bitbucket", icon: "bitbucket", category: "tools", level: 4 },
    { name: "Visual Studio Code", icon: "vscode", category: "tools", level: 5 },
    { name: "Linux", icon: "linux", category: "tools", level: 4 },
    { name: "Figma", icon: "figma", category: "tools", level: 3 },
  ],
  experiences: {
    en: [
      {
